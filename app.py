...
<button id="toggle-admin-password" class="toggle-pass" type="button" aria-label="Show password" aria-pressed="false">&#128065;</button>
</div>
<button type="submit">Login</button>
</form>
<p class="footer"><a href="/login">Back to user login</a></p>
<script>
(function () {
